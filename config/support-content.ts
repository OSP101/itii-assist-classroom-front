...
export const privacySections: PolicySection[] = [
  {
    ...
    icon: "solar:database-bold",
    items: [
      "นโยบายนี้ใช้กับข้อมูลส่วนบุคคลที่เกี่ยวข้องกับการใช้งาน ITII Assist Classroom สำหรับการเรียนการสอน การสนับสนุนผู้ใช้ และการรักษาความปลอดภัยของระบบ",
...
export const termsSections: PolicySection[] = [
  {
    ...
    items: [
      "การเข้าสู่ระบบหรือใช้งาน ITII Assist Classroom หมายถึงผู้ใช้รับทราบและยอมรับข้อกำหนดฉบับนี้ รวมถึงนโยบายความเป็นส่วนตัว นโยบายคุกกี้ และแนวทางความปลอดภัยที่เกี่ยวข้อง",
