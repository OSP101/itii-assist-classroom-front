...
export const supportGuideSections: SupportGuideSection[] = [
  {
    ...
    audience: "นักศึกษา",
    summary: "เริ่มใช้งานครั้งแรก เช็กชื่อ เข้าคิว ดูคะแนน และแก้ปัญหาเบื้องต้นตามขั้นตอนที่ควรทำจริง",
    icon: "solar:user-id-bold",
    bullets: [
      "ตรวจรายวิชาและ section หลังเข้าสู่ระบบ",
      "เปิดสิทธิ์ browser ที่จำเป็นก่อนเช็กชื่อหรือสแกน QR",
      "รวบรวมหลักฐานก่อนแจ้งปัญหาคะแนนหรือเช็กชื่อ",
    ],
  },
  {
    id: "instructor",
    ...
    audience: "ผู้สอน",
    summary: "เตรียมรายวิชา ตั้งงาน เช็กชื่อ ให้คะแนน อนุมัติคำขอแก้คะแนน จัดคิว และปิดรายวิชาอย่างเป็นระบบ",
  ...
  },
  {
    ...
    audience: "TA",
    summary: "ตรวจสิทธิ์ งานเช็กชื่อ ตรวจงาน ให้คะแนน คิว คำขอแก้คะแนน และรายงานผู้สอนรายสัปดาห์",
  ...
  },
  {
    ...
    audience: "ทุกบทบาท",
    summary: "แก้ปัญหาเข้าระบบ สิทธิ์ เช็กชื่อ คิว คะแนน และเตรียมข้อมูลให้ทีมช่วยเหลือตรวจสอบได้เร็วขึ้น",
  ...
  {
    id: "attendance",
    title: "เช็กชื่อและติดตามการเข้าเรียน",
    audience: "นักศึกษา",
    summary: "รองรับการเช็กชื่อด้วยตนเองหรือผ่าน QR และมีเส้นทางสำหรับขอแก้ไขรายการที่ผิดพลาด",
    icon: "solar:users-group-rounded-bold",
    bullets: [
      "เช็กชื่อภายในเวลาที่ผู้สอนเปิด session ไว้เท่านั้น",
      "ถ้าเช็กชื่อผิดคนหรือพลาด session ให้ส่งคำขอแก้ไขพร้อมเหตุผลประกอบ",
  ...
  },
  {
    ...
    bullets: [
      "ระบบขอตำแหน่งที่ตั้งเฉพาะเมื่อจำเป็นต่อการเช็กชื่อแบบยืนยันพื้นที่ตามเงื่อนไขของรายวิชา",
...
export const supportFaqItems: SupportFaqItem[] = [
  ...
  },
  {
    id: "attendance-1",
    category: "attendance",
    question: "เช็กชื่อไม่ทันในช่วงเวลาที่เปิด session ต้องทำอย่างไร",
    answer: "ให้ติดต่อผู้สอนหรือส่งคำขอแก้ไขการเช็กชื่อพร้อมเหตุผลและเวลาที่เกิดเหตุ เพื่อให้ผู้สอนพิจารณาเป็นรายกรณี",
    tags: ["attendance", "late", "session"],
  },
  {
    id: "attendance-2",
    category: "attendance",
    question: "สถานะการเช็กชื่อแต่ละแบบหมายถึงอะไร",
  ...
  },
  {
    ...
    answer: "ตำแหน่งที่ตั้งใช้เฉพาะกรณีเช็กชื่อที่ผู้สอนกำหนดให้ยืนยันพื้นที่ กล้องใช้เพื่อสแกน QR Code และการแจ้งเตือนใช้แจ้งเหตุสำคัญของคิว คะแนน หรือระบบ ทั้งหมดควรใช้เท่าที่จำเป็นต่อการให้บริการเท่านั้น",
...
export const supportResponseLanes: SupportLane[] = [
  ...
  },
  {
    ...
    description: "ปัญหาเกี่ยวกับงาน, เช็กชื่อ, คิว, คะแนน และการประสานงานกับผู้สอน",
  },
  {
...
export const supportRequestCategories = [
  ...
  { value: "learning", label: "งาน, เช็กชื่อ, คิว, คะแนน" },
...
export const privacySections: PolicySection[] = [
  {
    ...
    icon: "solar:database-bold",
    items: [
      "นโยบายนี้ใช้กับข้อมูลส่วนบุคคลที่เกี่ยวข้องกับการใช้งาน COCO LABS สำหรับการเรียนการสอน การสนับสนุนผู้ใช้ และการรักษาความปลอดภัยของระบบ",
  ...
  },
  {
    ...
    items: [
      ...
      "ข้อมูลการเรียนการสอน เช่น รายวิชา section กลุ่ม งาน คะแนน คำขอแก้ไขคะแนน การเช็กชื่อ คิวตรวจงาน และบันทึกกิจกรรมในรายวิชา",
      "ข้อมูลจากอุปกรณ์และระบบ เช่น IP โดยสังเขป user agent เวลาเข้าใช้งาน log เหตุการณ์ความปลอดภัย token การแจ้งเตือน และข้อมูลตำแหน่งเมื่อผู้ใช้เลือกเช็กชื่อแบบยืนยันพื้นที่",
  ...
  },
  {
    ...
    items: [
      "ใช้ข้อมูลเพื่อให้บริการตามบทบาทในรายวิชา เช่น จัดการสมาชิก ตรวจงาน ให้คะแนน เช็กชื่อ จองคิว และแสดงผลคะแนนหรือสถานะที่เกี่ยวข้อง",
...
export const termsSections: PolicySection[] = [
  {
    ...
    items: [
      "การเข้าสู่ระบบหรือใช้งาน COCO LABS หมายถึงผู้ใช้รับทราบและยอมรับข้อกำหนดฉบับนี้ รวมถึงนโยบายความเป็นส่วนตัว นโยบายคุกกี้ และแนวทางความปลอดภัยที่เกี่ยวข้อง",
  ...
  },
  {
    ...
    items: [
      "ใช้ระบบเพื่อวัตถุประสงค์ด้านการเรียนการสอน การประสานงานรายวิชา การให้คะแนน การเช็กชื่อ การจองคิว และการสนับสนุนที่เกี่ยวข้องเท่านั้น",
  ...
  },
  {
    ...
    items: [
      ...
      "ระบบอาจแสดงข้อมูลบางส่วนตามบทบาท เช่น คะแนน คิว การเช็กชื่อ สถานะงาน หรือ activity log เพื่อให้ workflow ทำงานได้ครบถ้วน",
