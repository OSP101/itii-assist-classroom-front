...
function getSecurityPageCopy(language: 'th' | 'en') {
    if (language === 'en') {
        return {
            ...
            metadataDescription: 'Responsible disclosure guidance and channels for reporting security issues in COCO LABS.',
    ...
    return {
        ...
        metadataDescription: 'แนวทาง Responsible Disclosure และช่องทางแจ้งปัญหาความปลอดภัยของ COCO LABS',
