...
function getTermsPageCopy(language: 'th' | 'en') {
    if (language === 'en') {
        return {
            ...
            metadataDescription: 'The ITII Assist Classroom terms of use for students, TAs, instructors, and administrators, including core responsibilities and prohibited behavior.',
            eyebrow: 'Terms of Use',
            title: 'Terms designed for the realities of an academic workflow',
            description: 'This document outlines the basic conditions for using ITII Assist Classroom for students, TAs, instructors, and administrators so classroom workflows can stay safe and fair.',
            ...
            sections: [
                {
                    ...
                    items: [
                        'Signing in to or using ITII Assist Classroom means the user acknowledges and accepts these terms together with the related privacy, cookie, and security policies.',
    ...
    return {
        ...
        metadataDescription: 'ข้อกำหนดการใช้งาน ITII Assist Classroom สำหรับผู้ใช้ทุกบทบาท รวมถึงข้อห้ามและความรับผิดชอบพื้นฐาน',
