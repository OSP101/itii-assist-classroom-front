...
const SEV = {
  high:   { dot: "bg-rose-500",  text: "text-rose-600",  label: "ด่วน",   labelCls: "bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400",  borderL: "border-l-rose-500",  rowBg: "hover:bg-rose-50/40 dark:hover:bg-rose-950/20" },
  medium: { dot: "bg-amber-500", text: "text-amber-600", label: "ควรทำ",  labelCls: "bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400", borderL: "border-l-amber-500", rowBg: "hover:bg-amber-50/30 dark:hover:bg-amber-950/10" },
  low:    { dot: "bg-blue-500",  text: "text-blue-600",  label: "แนะนำ",  labelCls: "bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400",   borderL: "border-l-blue-500",  rowBg: "hover:bg-blue-50/30 dark:hover:bg-blue-950/10" },
};
          ...
          <div key={item.id} className={`flex items-center gap-3 py-2.5 sm:py-3.5 first:pt-0 last:pb-0 border-l-[3px] pl-3 rounded-r-lg transition-colors ${s.borderL} ${s.rowBg}`}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                <span className={`text-[10px] font-medium px-1.5 py-0.5 rounded-md ${s.labelCls}`}>{s.label}</span>
              </div>
