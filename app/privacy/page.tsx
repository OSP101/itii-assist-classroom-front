...
function getPrivacyPageCopy(language: 'th' | 'en') {
    if (language === 'en') {
        return {
            ...
            metadataDescription: 'The ITII Assist Classroom privacy policy explains what data is used, why it is processed, and what rights users have.',
            eyebrow: 'Privacy Policy',
            title: 'We explain what data is used so people understand what the platform stores and why',
            description: 'This document applies to ITII Assist Classroom services and focuses on the data needed for teaching operations, user support, and platform security.',
            ...
            sections: [
                {
                    ...
                    items: [
                        'This policy covers personal data related to the use of ITII Assist Classroom for teaching, user support, and platform security.',
    ...
    return {
        ...
        metadataDescription: 'นโยบายความเป็นส่วนตัวของ ITII Assist Classroom อธิบายข้อมูลที่เก็บ วิธีใช้ข้อมูล และสิทธิของผู้ใช้งาน',
