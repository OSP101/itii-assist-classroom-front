...
function AdminLayoutContent({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div data-auth-shell="true" className="flex min-h-screen bg-background text-foreground max-lg:app-mobile-screen max-lg:overflow-hidden">
            {/* Mobile Overlay */}
            {isMobileSidebarOpen && (
                <div 
            ...
            <aside
                className={`
                    fixed left-0 top-0 z-50 h-screen max-lg:h-[100dvh] border-r border-divider bg-content1 
            ...
            >
                ...
                {/* Logo */}
                <div className="flex h-16 items-center border-b border-divider px-4 max-lg:pt-[env(safe-area-inset-top)]">
                ...
                {/* Navigation */}
                <nav className="h-[calc(100vh-8rem)] max-lg:h-[calc(100dvh-8rem-env(safe-area-inset-top))] space-y-1 overflow-y-auto p-3">
            ...
            <div className={`flex min-w-0 flex-1 flex-col transition-all duration-300 max-lg:min-h-0 max-lg:overflow-hidden ${sidebarCollapsed ? 'lg:ml-16' : 'lg:ml-64'}`}>
                {/* Header */}
                <header className="sticky top-0 z-30 border-b border-divider bg-content1/95 backdrop-blur">
                    <div className="flex h-14 items-center justify-between px-4 max-lg:pt-[env(safe-area-inset-top)] sm:h-16 sm:px-6">
                ...
                <main className="flex-1 max-lg:app-mobile-scroll max-lg:overflow-x-hidden">
                    <div className="p-3 sm:p-4 lg:p-6 max-lg:pb-[calc(env(safe-area-inset-bottom)+1rem)]">
