...
- จัดการ section, งาน, คะแนน, สอบ, เช็คชื่อ, คิว
- อนุมัติ/ปฏิเสธคำขอแก้คะแนน
- ดู activity log และสถิติ TA

3. TA (ผู้ช่วยสอน)
- ทำงานในรายวิชาที่ได้รับมอบหมาย
- ให้คะแนน, จัดการเช็คชื่อ/คิว, จัดการทีม (ตาม permission)
...
- แก้ไขสถานะเช็คชื่อรายบุคคลหรือ bulk
...
1. เริ่มเทอม
- สร้างรายวิชา -> สร้าง section -> เพิ่ม TA -> เพิ่มนักศึกษา -> ตั้งค่างาน/สอบ/เช็คชื่อ

2. ระหว่างเทอม
- เปิดรอบเช็คชื่อ -> เปิดคิว -> ตรวจงานและให้คะแนน -> จัดการคำขอแก้คะแนน
