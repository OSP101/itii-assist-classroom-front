...
| สร้างรอบเช็กชื่อ | ได้ | ได้ | ได้ตาม permission | ไม่ได้ |
| เช็กชื่อ | ไม่ได้ | ไม่ได้ | ไม่ได้ | ได้ |
...
| `create_attendance_sessions` | สร้างรอบเช็กชื่อ |
| `update_attendance_sessions` | แก้ไข/เปิด/ปิดรอบเช็กชื่อ |
| `update_attendance_status` | ปรับสถานะเช็กชื่อรายบุคคล/bulk |
| `view_teams` | ดูทีม |
...
- TA คะแนน, TA เช็กชื่อ, TA คิว/หน้างาน
