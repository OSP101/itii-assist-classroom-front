...
const TH_COPY = {
    ...
    manual: {
        ...
        byRole: {
            ...
            student: 'ครอบคลุมเข้าสู่ระบบด้วย KKU Mail เช็คชื่อ QR/PIN จองคิวตรวจงาน ดูคะแนนและการแจ้งเตือน',
        },
    },
    ...
    roles: [
        { key: 'all' as const, label: 'ทั้งหมด', icon: 'solar:widget-4-linear', description: '', accent: 'bg-slate-100 text-slate-600' },
        {
            ...
            description: 'ส่งงาน เช็คชื่อ เข้าคิว ดูคะแนน และแก้ปัญหาเบื้องต้นด้วยตัวเอง',
    ...
    lanes: {
        ...
        'Learning Workflow': {
            ...
            description: 'ส่งงาน เช็คชื่อ คิว คะแนน และเรื่องที่ต้องประสานกับอาจารย์ผู้สอน',
        },
        'Security & Abuse': {
