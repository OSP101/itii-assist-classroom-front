...
export function AppFooter({ userEmail }: AppFooterProps) {
    ...
    return (
        <>
            <footer className="app-safe-bottom flex min-h-12 flex-col items-center justify-center gap-2 border-t border-divider bg-content1 px-4 py-3 text-[13px] text-default-500 lg:flex-row">
